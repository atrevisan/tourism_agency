...
from com.tourism.gui.ui_widget_register_plane_ticket import Ui_widget_register_plane_ticket 
...
class WidgetRegisterPlaneTicket(QWidget, Ui_widget_register_plane_ticket):
    """This widget is intended for plane tickets registration.
    ...
    def __init__(self):
        ...
        self.button_register.clicked.connect(self.register_plane_ticket)
    ...
    def register_plane_ticket(self):
        """Perform the plane ticket registration on the server."""
        ...
        self.check_only_departure.setChecked(False)
